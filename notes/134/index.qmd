...
spotlight: ""
---
These instructions are adapted for my own customized `tmux` prefix key, set to `ctrl-q`. You will obviously need to adapt them to your own prefix key if different.
