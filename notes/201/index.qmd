...
A held package is pinned at its current version: `apt upgrade` and `apt full-upgrade` skip it entirely. Useful to prevent a known-broken release from landing, or to freeze a critical package until you are ready to upgrade.
