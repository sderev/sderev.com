...
description: "My notes for the first week of the Mastering LLM course/conference."
image: "img/robot_reading_a_book.png"
---
Since this was a verbal presentation, I have rephrased the quotes for better readability, and enriched some of the content with additional information.

## Start Simple

> * Do not start by trying to fine-tune but with prompt engineering and RAG
...
### A Prompt Engineering is Impractical

When dealing with complex tasks requiring numerous conditions and detailed prompts, prompt engineering can become inefficient. Then, fine-tuning can be a better solution.
...
**Remark**: the 23th of May, 2024, an article was published on a new algorithm found to be both simpler and more effective than DPO: [Simple Preference Optimization (SimPO)](https://arxiv.org/abs/2405.14734). This is very new at the time of writing (25th of May, 2024), so we will have to wait and see how it really performs.
...
DPO consistently produced "super human" responses in comparison of the other methods.
...
* [Air Canada has to honor a refund policy its chatbot made up](https://www.wired.com/story/air-canada-chatbot-refund-policy/)
* [Belgian man dies by suicide following exchanges with chatbot](https://www.brusselstimes.com/430098/belgian-man-commits-suicide-following-exchanges-with-chatgpt)
* [The SimPO article (Meng *et al.*, 2024)](https://arxiv.org/abs/2405.14734)
* [The original article on the DPO algorithm (Rafailov *et al.*, 2023)](https://arxiv.org/abs/2305.18290)
* [A practical example of DPO with the TRL library from HuggingFace](https://huggingface.co/docs/trl/main/en/dpo_trainer)
